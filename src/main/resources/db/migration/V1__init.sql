...
alter table if exists projects_employees
    add constraint projects_employees_fk foreign key (employee_id) references employees;
alter table if exists projects_employees
...
alter table if exists tasks_employees
    add constraint tasks_employees_fk foreign key (employee_id) references employees;
alter table if exists tasks_employees
